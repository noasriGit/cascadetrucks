...
export const services: Service[] = [
  ...
  },
  {
    ...
    relatedServiceSlugs: ["plumbing-vehicle-insurance", "hvac-vehicle-insurance", "construction-vehicle-insurance", "business-auto-insurance"],
    relatedLocationSlugs: NOVA,
  ...
  },
  {
    ...
    relatedServiceSlugs: ["hvac-vehicle-insurance", "contractor-vehicle-insurance", "business-auto-insurance"],
  ...
  },
  {
    ...
    relatedServiceSlugs: ["plumbing-vehicle-insurance", "contractor-vehicle-insurance", "business-auto-insurance"],
    relatedLocationSlugs: LOUDOUN,
    relatedResourceSlugs: ["virginia-commercial-auto-insurance-guide"],
    relatedVehicleSlugs: [
      "cargo-van-insurance",
  ...
  },
  {
    ...
    relatedServiceSlugs: ["commercial-auto-insurance", "business-auto-insurance", "dump-truck-insurance", "construction-vehicle-insurance"],
  ...
  },
  {
    ...
    faqIds: ["general-requirements", "general-cost", "general-multi-vehicle", "general-quote-speed"],
    relatedServiceSlugs: ["commercial-fleet-insurance", "business-auto-insurance", "contractor-vehicle-insurance", "tow-truck-insurance"],
    relatedLocationSlugs: DEFAULT_LOCATIONS,
    relatedResourceSlugs: ["virginia-commercial-auto-insurance-guide", "commercial-fleet-insurance-guide"],
    relatedVehicleSlugs: [
      "box-truck-insurance",
