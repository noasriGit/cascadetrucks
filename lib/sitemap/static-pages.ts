...
export const staticSitemapPages: StaticSitemapPageConfig[] = [
  ...
  },
  {
    ...
    description: "How Cascade Truck Insurance collects, uses, and protects information submitted online.",
    category: "Company",
    sortPriority: 10,
    xmlPriority: 0.4,
    xmlChangeFrequency: "yearly",
  },
  {
    path: "/terms",
    title: "Terms of Use",
    description: "Terms of use for the Cascade Truck Insurance website.",
    category: "Company",
    sortPriority: 11,
    xmlPriority: 0.4,
    xmlChangeFrequency: "yearly",
  },
  {
    ...
    description: "How Cascade Truck Insurance researches, reviews, and updates insurance guides.",
    category: "Company",
    sortPriority: 12,
    xmlPriority: 0.4,
    xmlChangeFrequency: "yearly",
